...
class Fan {
    ...
    public Fan(int speed, boolean FanStateOn, double radius, String color)
    {
        // Set the fan speed, fanState, radius, and color
        this.speed = speed;
        this.FanStateOn = FanStateOn;
        this.radius = radius;
        this.color = color;
    }
    ...
    public String toString() {
        ...
        // Adding adjustment to make the output read speed as text instead of the number value
        String speedText;
        switch (speed) {
            case SLOW:
                speedText = "Slow";
        ...
        // If the fan is on, display its speed, color, and radius
        if (FanStateOn) {
            return "\nFan status: On \nFan speed: " + speedText + "\nColor: " + color + "\nRadius: " + radius;
        }
        // If the fan is off, display only its color and radius since the implied speed would be STOPPED
        else {
            return "\nFan status: Off \nColor: " + color + "\nRadius: " + radius;
        }
    }
